...
import logo from '../vikramlogo.JPG';
export const Header = () => {
    ...
    return(
        <header className="border-b-2 border-gray-400">
            ...
            <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                <img src={logo} className="h-15 w-40" alt="Flowbite Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MovieWorld</span>
            </a>
